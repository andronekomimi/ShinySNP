                       ...
                       list(
                         navbarPage(span("Analysis", style = "color:green"),
                                    tabPanel("3D Conformation and Regulation",
                                             ...
                                             br(),
                                             bsCollapse(id = "overlap1", open = c('Overlap with variants'), multiple = FALSE,
                                                        bsCollapsePanel('Overlap with variants',verbatimTextOutput(outputId = "overlap_plot1"), 
                                                                        style = "default")
                                             ),
                                             br(),
                                             hr(),
                                             ...
                                             br(),
                                             bsCollapse(id = "overlap1b", open = c('Overlap with variants'), multiple = FALSE,
                                                        bsCollapsePanel('Overlap with variants',verbatimTextOutput(outputId = "overlap_plot1b"), 
                                                                        style = "default")
                                             ),
                                             br(),
                                             hr(),
                                             ...
                                             br(),
                                             bsCollapse(id = "overlap2", open = c('Overlap with variants'), multiple = FALSE,
                                                        bsCollapsePanel('Overlap with variants',verbatimTextOutput(outputId = "overlap_plot2"), 
                                                                        style = "default")
                                             ),
                                             br(),
